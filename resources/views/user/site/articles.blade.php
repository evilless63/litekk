...
@section('content')
<main class="mb-5 mt-5 text-sm-center text-md-left">

        <div class="container breadcrumbs">
            <a href="">Главная</a> > <a href="">Статьи</a> > <a href="">Категория</a>
        </div>
        <div class="container">
            <h1 class="mt-5">Интересные статьи</h1>
        </div>
        <div class="container filter mt-5">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-4 col-xs-12 filter__category mt-2">
                    Выберите категорию статей<i class="fa fa-angle-down ml-2"></i>
                </div>
