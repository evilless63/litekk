...
<main class="pb-5 pt-5 text-sm-center text-md-left product-background product">
    ...
    <div class="row mt-5">
        <p>
        6.	Устройство: 
- наматывающий агрегат – сборно-сварная ферма из резано-гнутых панелей с защитными кожухами и крышками, на которой установлены - 3х фазный асинхронный электродвигатель 0,75кВт, 2800об/мин., червячный редуктор i=5, ременные передачи с зубчатыми ремнями и шкивами, подшипниковые опоры, шпиндели, мотовила, сменные крючки;
- натяжители шпагата – панели с установленными пружинными прижимами и  направляющими устройствами;
- полки бобин нитей с установочными штырями;
- ребро жесткости машины;
- шкаф управления с  установленным электрооборудованием (преобразова-тель частоты, реле, панель управления и индикации, кнопки, датчики, лам-почки, счетчики импульсов, переключатели и выключатели, проводка, кон-тур заземления) и полками;
- технологический шкаф, формирующий конечный вид станины машины и имеющий полки для размещения инструмента и материалов;                                              - фотобарьеры безопасности для предотвращения травмирования персонала вращающимися частями машины при попадании частей тела в зоны намотки шпагата (нити) на крючки.
</p>
    </div>
        <div class="row mt-5">
        ...
        <div class="row mt-5 d-flex">
            <div class="col">
                <a href="{{route('3dmodel', 'p2pm2n')}}" target="_blank" class="model-show d-flex align-items-center">
        ...
        <div class="row mt-5">
            <div class="col d-flex justify-content-center">
                <img class="img-fluid"  src="{{asset('images/products/p2pm2n/front.jpg')}}" alt="">
            </div>
        </div>
