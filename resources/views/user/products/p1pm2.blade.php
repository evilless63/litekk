...
<main class="pb-5 pt-5 text-sm-center text-md-left product-background product">
    ...
    <div class="container breadcrumbs">
        <a href="/">Главная</a> > <a data-toggle="collapse" href="#collapseCatalog">Товары</a> > <a href="">Серия П1пм3-шнк</a>
    </div>
    <div class="container pt-5">
        <div class="row product d-flex align-items-center">
            <div class="col-md-6 col-xs-12">
                <img src="{{asset('images/products/p1pm2/perspective.png')}}" class="img-fluid product__image" alt="Серия П1пм3-шнк">
            </div>
            <div class="col-md-6 col-xs-12">
                <h1 class="product__header">Серия П1пм3-шнк</h1>
            ...
            <div class="row pt-3">
                <div class="col">
                    <table class="table table-striped">
                        <tbody>
                            <tr>
                                <td>Длина (по торцам крепежных хомутов поручней)</td>
                                <td>1992 мм</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Ширина (по краям торцевых балок платформы)</td>
                                <td>810 мм</td>
                            </tr>
                            <tr>
                                <td>Переставной по высоте поддон</td>
                                <td>1930х600 мм</td>
                            </tr>
                            <tr>
                                <td>Масса тележки</td>
                    ...
                    <div class="table__e2e2e2">
                        <p>Ходовая платформа с грузоприемной площадкой 1930х600мм оснащена:</p>
                        <ul>
                            <li>центр. (рулевыми) колесами Ø200 - 2шт</li>
                            <li>поворотными колесами Ø125- 4шт</li>
                            <li>полиамидными катками Ø Ø140/90хL145 - 4шт</li>
                        </ul>
                        <p>Для перемещения по регистрам установлены на осях и шарикоподшипниках 4 полиамидных катка с ребордами. Для перемещения по полу установлены центральные (рулевые) колеса на осях и колеса на поворотных опорах.</p>
                        <p>
                            Тележки имеют ходовую раму с поручнями и переставляемым по высоте поддоном из оцинкованного листа. При перестановке поддона на поручни образуется 2й этаж. Окраска непокрытых поверхностей – порошковой эмалью.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6 col-xs-12 top__product">
                <img class="img-fluid" src="{{asset('images/products/p1pm2/top.jpg')}}" alt="">
                <p class="mt-5">Тележки предназначены для сбора урожая и обслуживания теплиц.
                    При эксплуатации происходит их индивидуальное перемещение вручную по труборельсам (отопительные регистры) и полу теплиц.</p>
            </div>
            <div class="col-md-6 col-xs-12 bottom__product">
                <img class="img-fluid" src="{{asset('images/products/p1pm2/bottom.jpg')}}" alt="">
                <p class="mt-5">
        ...
        <div class="row mt-5 d-flex">
            <div class="col">
                <a href="{{route('3dmodel', 'p1pm2')}}" target="_blank" class="model-show d-flex align-items-center">
