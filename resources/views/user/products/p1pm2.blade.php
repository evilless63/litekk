...
<main class="pb-5 pt-5 text-sm-center text-md-left product-background product">
        ...
        overflow: hidden;
        margin-top: -105px;" ><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;"><path d="M0.00,49.98 C149.99,150.00 349.20,-49.98 500.00,49.98 L500.00,150.00 L0.00,150.00 Z" style="stroke: none; fill: #dcdcdc;"></path></svg></div>
        ...
        <div class="container product-feedback mt-5 pt-5">
            ...
            <div class="row feedback-form mt-5">
                <div class="col-md-5 col-sx-12">
                    ...
                    <button type="text" class="feedback-form__file d-flex justify-content-start align-items-center"><img
                            src="images/template/add_files.png" class="mr-3" alt=""> Прикрепить фото и
                        документы</button>
                </div>
                <div class="col-md-7 col-sx-12">
                    <div class="row">
                        <textarea rows="5" cols="45" class="feedback-form__textarea"
        ...
        <div class="container product-docs mt-5 pt-5">
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <a href="#" type="text" class="d-flex justify-content-start align-items-center"><img
                        src="images/template/product-docs.png" class="mr-3" alt="">ПОЛНАЯ ДОКУМЕНТАЦИЯ</a>
                </div>
            </div>
        </div>
