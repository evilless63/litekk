    ...
    <div class="container pt-5">
        <div class="row product d-flex align-items-center">
            <div class="col-md-6 col-xs-12">
                <img src="{{asset('images/products/phrbg/perspective.png')}}" class="img-fluid product__image" alt="Серия Пхр-б/г">
            </div>
            <div class="col-md-6 col-xs-12">
                <h1 class="product__header">Серия Пхр-б/г</h1>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6 col-xs-12 top__product">
                <img class="img-fluid" src="{{asset('images/products/phrbg/top.jpg')}}" alt="">
            ...
            <div class="col-md-6 col-xs-12 bottom__product">
                <img class="img-fluid" src="{{asset('images/products/phrbg/bottom.jpg')}}" alt="">
                <p class="mt-5">
        ...
        <div class="row mt-5 d-flex">
            <div class="col">
                <a href="{{route('3dmodel', 'phrbg')}}" target="_blank" class="model-show d-flex align-items-center">
        ...
        <div class="row mt-5">
            <div class="col d-flex justify-content-center">
                <img class="img-fluid" src="{{asset('images/products/phrbg/front.jpg')}}" alt="">
            </div>
        </div>
        ...
        <div class="row benefits mt-5 pt-5">
            ...
            <div class="col-md-5 d-flex justify-content-center">
                <img class="img-fluid" src="{{asset('images/products/phrbg/left.jpg')}}" alt="">
            </div>
            <div class="col-md-3">
                <div class="d-flex flex-column">
                    <div class="p-2">
