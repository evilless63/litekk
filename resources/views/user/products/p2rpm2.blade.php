...
<main class="pb-5 pt-5 text-sm-center text-md-left product-background product">
    ...
    <div class="container breadcrumbs">
        <a href="/">Главная</a> > <a data-toggle="collapse" href="#collapseCatalog">Товары</a> > <a href="">Серия П2-РПМ2</a>
    </div>
    <div class="container pt-5">
        <div class="row product d-flex align-items-center">
            <div class="col-md-6 col-xs-12">
                <img src="{{asset('images/products/p2rpm2/perspective.png')}}" class="img-fluid product__image" alt="Серия П2-РПМ2">
            </div>
            <div class="col-md-6 col-xs-12">
                <h1 class="product__header">Серия П2-РПМ2</h1>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6 col-xs-12 top__product">
                <img class="img-fluid" src="{{asset('images/products/p2rpm2/top.jpg')}}" alt="">
                <p class="mt-5">Описание скоро появится</p>
            </div>
            <div class="col-md-6 col-xs-12 bottom__product">
                <img class="img-fluid" src="{{asset('images/products/p2rpm2/bottom.jpg')}}" alt="">
                <p class="mt-5">
                    Описание скоро появится
                </p>
            </div>
        ...
        <div class="row mt-5 d-flex">
            <div class="col">
                <a href="{{route('3dmodel', 'p2rpm2')}}" target="_blank" class="model-show d-flex align-items-center">
        ...
        <div class="row mt-5">
            <div class="col d-flex justify-content-center">
                <img class="img-fluid"  src="{{asset('images/products/p2rpm2/front.jpg')}}" alt="">
            </div>
        </div>
        ...
        <div class="row benefits mt-5 pt-5">
            ...
            <div class="col-md-5 d-flex justify-content-center">
                <img class="img-fluid" src="{{asset('images/products/p2rpm2/left.jpg')}}" alt="">
            </div>
            <div class="col-md-3">
                <div class="d-flex flex-column">
                    <div class="p-2">
