...
<main class="pb-5 pt-5 text-sm-center text-md-left product-background product">
    ...
    <div class="container breadcrumbs">
        <a href="/">Главная</a> > <a data-toggle="collapse" href="#collapseCatalog">Товары</a> > <a href="">Серия П1кпм</a>
    </div>
    <div class="container pt-5">
        <div class="row product d-flex align-items-center">
            <div class="col-md-6 col-xs-12">
                <img src="{{asset('images/products/t003/perspective.png')}}" class="img-fluid product__image" alt="Серия П1кпм">
            </div>
            <div class="col-md-6 col-xs-12">
                <h1 class="product__header">Серия П1кпм</h1>
            ...
            <div class="row pt-3">
                <div class="col">
                    ...
                    <div class="table__e2e2e2">
                        ...
                        <p>
                            Контейнер для сбора мусора устанавливается на платформу на имеющиеся у него специальные опоры, оснащенные упорными загибами для фиксации контейнера от смещений по раме платформы. Для установки и съема контейнера вилами погрузчика на нем имеются захваты.
                        </p>
                        <p>
                            Контейнер изготовлен из профильных труб, облицован оцинкованным листом, имеет поручни для ручного перемещения тележки. Для максимального исключения зацепов растений углы у контейнера скошены.
                        </p>
                        <p>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6 col-xs-12 top__product">
                <img class="img-fluid" src="{{asset('images/products/t003/top.jpg')}}" alt="">
                <p class="mt-5"> Тележки предназначены для сбора растительных отходов.
                    При эксплуатации происходит их индивидуальное перемещение вручную по труборельсам (отопительные регистры) и полу теплиц или в сцепке с другими тележками напольным транспортом. Тележки имеют ходовую платформу тележек-рольгангов - закрытого типа, которая максимально исключает зацепы стеблями растений за элементы конструкции, т.к. вся колесная часть скрыта под неё.
                </p>
            </div>
            <div class="col-md-6 col-xs-12 bottom__product">
                <img class="img-fluid" src="{{asset('images/products/t003/bottom.jpg')}}" alt="">
                <p class="mt-5">
        ...
        <div class="row mt-5">
            <div class="col d-flex justify-content-center">
                <img src="{{asset('images/products/t003/front.jpg')}}" alt="">
            </div>
        </div>
        ...
        <div class="row benefits mt-5 pt-5">
            ...
            <div class="col-md-5 d-flex justify-content-center">
                <img class="img-fluid" src="{{asset('images/products/t003/left.jpg')}}" alt="">
            </div>
            <div class="col-md-3">
                <div class="d-flex flex-column">
                    <div class="p-2">
