                ...
                <div class="card-body">
                    ...
                    <form action="{{route('news.update', $news->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('header') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{ $news->header }}" name="header" class="form-control" id="header" aria-describedby="header" placeholder="заголовок" required>
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <textarea type="text" value="{{ $news->description }}" name="description" class="form-control" id="description" placeholder="Краткое описание" required>{{ $article->description }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('text') ? ' has-error' : '' }}">
                            ...
                            <textarea type="text" value="{{ $news->text }}" name="text" class="form-control" id="text" aria-describedby="text" placeholder="Текст статьи" required>{{ $article->text }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <img class="img-fluid mb-4" src="/images/articles/{{ $news->image }}" alt="{{$news->header}}">
                            <label for="image">Основное изображение</label>
                            <input type="file" value="{{ $news->image }}" name="image" id="image" placeholder="Основное изображение">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="categoriesarticle_id" value="{{$news->categoriesarticle_id}}">
                            <select name="categoriesarticle_id" class="selectpicker show-tick">
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{$category->id == $news->categoriesarticle_id ? "selected='selected'" : "" }} >{{$category->title}}</option>
                            @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('meta_keys') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{ $news->meta_keys }}" name="meta_keys" class="form-control" id="meta_keys" aria-describedby="meta_keys" placeholder="Мета ключи">
                        ...
                        <div class="form-group {{ $errors->has('meta_description') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{ $news->meta_description }}" name="meta_description" class="form-control" id="meta_description" aria-describedby="meta_description" placeholder="Мета описание">
                        ...
                        <div class="form-group {{ $errors->has('meta_title') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{ $news->meta_title }}" name="meta_title" class="form-control" id="meta_title" aria-describedby="meta_title" placeholder="Мета заголовок">
                        ...
                        <button type="submit" class="btn btn-primary">Внести изменения в новость</button>
                    </form>
                </div>
            </div>
        </div>
